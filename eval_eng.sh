...
# TASKS=("ArguAna" "Banking77Classification" "BiorxivClusteringS2S" "EmotionClassification" "MassiveIntentClassification" "MedrxivClusteringS2S" "NFCorpus" "SICK-R" "STS17" "STSBenchmark" "SciDocsRR" "SciFact" "SprintDuplicateQuestions" "StackOverflowDupQuestions" "TwentyNewsgroupsClustering")
